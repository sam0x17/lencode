...
fn test_decode_varint_2() {
    ...
    let mut reader = BitReader::<_>::new(Cursor::new(data));
    let value: u64 = BitVarInt::decode_bitvarint(&mut reader).unwrap();
    assert_eq!(format!("{value:064b}"), format!("{:064b}", 2u64));
    assert_eq!(value, 2);
}
...
fn test_decode_varint_3() {
    ...
    let mut reader = BitReader::<_>::new(Cursor::new(data));
    let value: u64 = BitVarInt::decode_bitvarint(&mut reader).unwrap();
    assert_eq!(format!("{value:064b}"), format!("{:064b}", 3u64));
    assert_eq!(value, 3);
}
...
fn test_decode_varint_4() {
    ...
    let mut reader = BitReader::<_>::new(Cursor::new(data));
    let value: u64 = BitVarInt::decode_bitvarint(&mut reader).unwrap();
    assert_eq!(format!("{value:064b}"), format!("{:064b}", 4u64));
    assert_eq!(value, 4);
}
...
fn test_decode_varint_5() {
    ...
    let mut reader = BitReader::<_>::new(Cursor::new(data));
    let value: u64 = BitVarInt::decode_bitvarint(&mut reader).unwrap();
    assert_eq!(format!("{value:064b}"), format!("{:064b}", 5u64));
    assert_eq!(value, 5);
}
...
fn test_decode_varint_6() {
    ...
    let mut reader = BitReader::<_>::new(Cursor::new(data));
    let value: u64 = BitVarInt::decode_bitvarint(&mut reader).unwrap();
    assert_eq!(format!("{value:064b}"), format!("{:064b}", 6u64));
    assert_eq!(value, 6);
}
...
fn test_decode_varint_7() {
    ...
    let mut reader = BitReader::<_>::new(Cursor::new(data));
    let value: u64 = BitVarInt::decode_bitvarint(&mut reader).unwrap();
    assert_eq!(format!("{value:064b}"), format!("{:064b}", 7u64));
    assert_eq!(value, 7);
}
...
fn test_decode_varint_8() {
    ...
    let mut reader = BitReader::<_>::new(Cursor::new(data));
    let value: u64 = BitVarInt::decode_bitvarint(&mut reader).unwrap();
    assert_eq!(format!("{value:064b}"), format!("{:064b}", 8u64));
    assert_eq!(value, 8);
}
...
fn test_decode_varint_9() {
    ...
    let mut reader = BitReader::<_>::new(Cursor::new(data));
    let value: u64 = BitVarInt::decode_bitvarint(&mut reader).unwrap();
    assert_eq!(format!("{value:064b}"), format!("{:064b}", 9u64));
    assert_eq!(value, 9);
}
...
fn test_decode_varint_10() {
    ...
    let mut reader = BitReader::<_>::new(Cursor::new(data));
    let value: u64 = BitVarInt::decode_bitvarint(&mut reader).unwrap();
    assert_eq!(format!("{value:064b}"), format!("{:064b}", 10u64));
    assert_eq!(value, 10);
}
...
fn test_decode_varint_11() {
    ...
    let mut reader = BitReader::<_>::new(Cursor::new(data));
    let value: u64 = BitVarInt::decode_bitvarint(&mut reader).unwrap();
    assert_eq!(format!("{value:064b}"), format!("{:064b}", 11u64));
    assert_eq!(value, 11);
}
...
fn test_decode_varint_12() {
    ...
    let mut reader = BitReader::<_>::new(Cursor::new(data));
    let value: u64 = BitVarInt::decode_bitvarint(&mut reader).unwrap();
    assert_eq!(format!("{value:064b}"), format!("{:064b}", 12u64));
    assert_eq!(value, 12);
}
...
fn test_decode_varint_114() {
    ...
    let mut reader = BitReader::<_>::new(Cursor::new(data));
    let value: u64 = BitVarInt::decode_bitvarint(&mut reader).unwrap();
    assert_eq!(format!("{value:064b}"), format!("{:064b}", 114u64));
    assert_eq!(value, 114);
}
...
fn test_decode_varint_507() {
    ...
    let mut reader = BitReader::<_>::new(Cursor::new(data));
    let value: u64 = BitVarInt::decode_bitvarint(&mut reader).unwrap();
    assert_eq!(format!("{value:064b}"), format!("{:064b}", 507u64));
    assert_eq!(value, 507);
}
...
fn test_decode_varint_14387324() {
    ...
    let mut reader = BitReader::<_>::new(Cursor::new(data));
    let value: u64 = BitVarInt::decode_bitvarint(&mut reader).unwrap();
    assert_eq!(format!("{value:064b}"), format!("{:064b}", 14387324u64));
